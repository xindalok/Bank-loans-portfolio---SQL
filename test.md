...
- [Overview KPIs](#overview-kpis)
      ...
      + [Explanation of SQL Code](#explanation-of-sql-code)
         - [Inner Query:](#inner-query)
         - [Outer Query:](#outer-query)
         - [Window Function:](#window-function)
      + [Total amount received](#total-amount-received)
      + [SQL Code Explanation](#sql-code-explanation-1)
         - [Subquery (`loan_month`):](#subquery-loan_month)
         - [Outer Query:](#outer-query-1)
      + [Average interest rate](#average-interest-rate)
      + [SQL Code Explanation](#sql-code-explanation-2)
         - [Subquery (`mthly_int`):](#subquery-mthly_int)
         - [Outer Query:](#outer-query-2)
      + [Average Debt-to-Income Ratio (DTI)](#average-debt-to-income-ratio-dti)
      + [SQL Code Explanation](#sql-code-explanation-3)
         - [Subquery (`mnthly_dti`):](#subquery-mnthly_dti)
         - [Outer Query:](#outer-query-3)
         - [Ordering:](#ordering)
- [Good Loan v Bad Loan KPI’s](#good-loan-v-bad-loan-kpis)
      + [SQL Code Explanation](#sql-code-explanation-4)
         - [Subquery (`count_good_loans`):](#subquery-count_good_loans)
         - [Outer Query:](#outer-query-4)
      + [SQL Code Explanation](#sql-code-explanation-5)
         - [Query Overview:](#query-overview)
         - [Filtering with `WHERE` Clause:](#filtering-with-where-clause)
         - [Aggregate Function:](#aggregate-function)
         - [Output:](#output)
      + [SQL Code Explanation](#sql-code-explanation-6)
         - [Query Overview:](#query-overview-1)
         - [Filtering with `WHERE` Clause:](#filtering-with-where-clause-1)
         - [Aggregate Function:](#aggregate-function-1)
         - [Output:](#output-1)
      + [SQL Code Explanation](#sql-code-explanation-7)
         - [Subquery (`count_bad_loans`):](#subquery-count_bad_loans)
         - [Outer Query:](#outer-query-5)
         - [Output:](#output-2)
      + [Loan Status Grid View Report](#loan-status-grid-view-report)
         - [Totals:](#totals)
         - [MTD:](#mtd)
   * [Key loan metrics](#key-loan-metrics)
      + [1. Monthly Trends by Issue Date  ](#1-monthly-trends-by-issue-date)
      + [2. Regional by State  ](#2-regional-by-state)
      + [3. Loan Term   ](#3-loan-term)
      + [4. Employment Length Analysis  ](#4-employment-length-analysis)
      + [5. Top 10 Income brackets with highest % of Bad loans](#5-top-10-income-brackets-with-highest-of-bad-loans)

<!-- TOC end -->

<!-- TOC --><a name="overview-kpis"></a>
# Overview KPIs

<!-- TOC --><a name="total-loan-applications"></a>
...
<!-- TOC --><a name="sql-code-explanation"></a>
### SQL Code Explanation

<!-- TOC --><a name="explanation-of-code"></a>
### Explanation of Code
...
<!-- TOC --><a name="total-funded-amount"></a>
### Total Funded Amount
...
<!-- TOC --><a name="explanation-of-sql-code"></a>
### Explanation of SQL Code

<!-- TOC --><a name="inner-query"></a>
#### Inner Query:
- **Aggregation**:  
...
<!-- TOC --><a name="total-amount-received"></a>
...
<!-- TOC --><a name="sql-code-explanation-1"></a>
### SQL Code Explanation

<!-- TOC --><a name="subquery-loan_month"></a>
#### Subquery (`loan_month`):
- **Month Extraction**:  
...
<!-- TOC --><a name="average-interest-rate"></a>
...
<!-- TOC --><a name="sql-code-explanation-2"></a>
### SQL Code Explanation

<!-- TOC --><a name="subquery-mthly_int"></a>
#### Subquery (`mthly_int`):
- **Month Extraction**:  
  - Extracts the numerical month using `EXTRACT(MONTH FROM issue_date) AS month_num`.  
  - Extracts the abbreviated month name using `TO_CHAR(issue_date, 'Mon') AS month`.
...
<!-- TOC --><a name="average-debt-to-income-ratio-dti"></a>
...
<!-- TOC --><a name="sql-code-explanation-3"></a>
### SQL Code Explanation

<!-- TOC --><a name="subquery-mnthly_dti"></a>
#### Subquery (`mnthly_dti`):
- **Month Extraction**:  
  - Extracts the numerical month using `EXTRACT(MONTH FROM issue_date) AS month_num`.  
  - Extracts the abbreviated month name using `TO_CHAR(issue_date, 'Mon') AS month`.
...
<!-- TOC --><a name="good-loan-v-bad-loan-kpis"></a>
...
<!-- TOC --><a name="sql-code-explanation-4"></a>
### SQL Code Explanation

<!-- TOC --><a name="subquery-count_good_loans"></a>
...
<!-- TOC --><a name="sql-code-explanation-5"></a>
### SQL Code Explanation

<!-- TOC --><a name="query-overview"></a>
#### Query Overview:
...
<!-- TOC --><a name="filtering-with-where-clause"></a>
...
<!-- TOC --><a name="aggregate-function"></a>
#### Aggregate Function:
- **Summation**:  
...
<!-- TOC --><a name="sql-code-explanation-6"></a>
### SQL Code Explanation

<!-- TOC --><a name="query-overview-1"></a>
#### Query Overview:
...
<!-- TOC --><a name="filtering-with-where-clause-1"></a>
#### Filtering with `WHERE` Clause:
- **Loan Status Filtering**:  
  - Filters rows based on the `loan_status` column:  
    - Includes only loans with `loan_status = 'Current'` or `loan_status = 'Fully Paid'`.  
...
<!-- TOC --><a name="aggregate-function-1"></a>
#### Aggregate Function:
- **Summation**:  
...
FROM financial_loan fl 
 ...
 ```
<!-- TOC --><a name="sql-code-explanation-7"></a>
### SQL Code Explanation

<!-- TOC --><a name="subquery-count_bad_loans"></a>
...
<!-- TOC --><a name="loan-status-grid-view-report"></a>
...
<!-- TOC --><a name="1-monthly-trends-by-issue-date"></a>
...
<!-- TOC --><a name="2-regional-by-state"></a>
### 2. Regional by State  
...
<!-- TOC --><a name="4-employment-length-analysis"></a>
...
<!-- TOC --><a name="5-top-10-income-brackets-with-highest-of-bad-loans"></a>
